...
public class Exercicio17 {
    /*
    * 17 - Considere uma matriz de distância entre cidades 6 x 6: --conferir anexo no documento--
    * Observe as regras a seguir:
    * ●	Primeira linha e primeira coluna representam cidades, que devem ser inseridos apenas por números.
    * 1 representa Cárceres, 2 BBurgres, 3 Cuiabá, e assim por diante.
    * ●	A Intersecção entre as cidades representa a distância entre elas
    * ●	Tanto o número que representa a cidade quanto as distâncias devem ser números flutuantes
    * ●	A distância igual a -1 representa que é a distância entre uma cidade e ela mesmo, o que não seria possível
    * (diagonal principal).
    */
