...
import exercicio16.exception.ListException;

/*
* 16- Uma lista duplamente encadeada possui registros que tem ligações com o sucessor e o predecessor de cada nó.
...
public class DinamicDoubleList {
    ...
    public void list() throws ListException {
        ...
        while(aux.getNoProximo() != this.head.getNoProximo()) {
